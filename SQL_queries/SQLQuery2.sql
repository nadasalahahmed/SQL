...
CREATE TABLE InstructorPhone (
    PhoneNum Bigint,
    InstructorID INT,
    PRIMARY KEY (PhoneNum ,InstructorID),
...
CREATE TABLE MemberShipPlansBenefits (
    ...
    PRIMARY KEY (MemberID, planName, benefits),
    FOREIGN KEY (MemberID, planName) REFERENCES MemberShipPlans(MemberID, planName)
);
...
-- 3. Insert Classes
INSERT INTO Class (ClassID, ClassName, Duration, ScheduleDate, MaxParticipant, InstructorID)
VALUES
...
-- 4. Insert Members
INSERT INTO Members (MemberID, Email, Firstname, City, Street, State)
VALUES
(1001, 'john.doe@email.com', 'John', 'Boston', '123 Main St', 'MA'),
(1002, 'jane.smith@email.com', 'Jane', 'Cambridge', '456 Oak Ave', 'MA'),
(1003, 'robert.j@email.com', 'Robert', 'Boston', '789 Pine Rd', 'MA'),
(1004, 'lisa.w@email.com', 'Lisa', 'Somerville', '321 Elm St', 'MA');
...
INSERT INTO WorkoutLogs (LogID, CaloriesBurned, Notes, LOGDate, MemberID)
VALUES
...
SELECT i.Fname + ' ' + i.Lname AS InstructorName, 
       c.ClassName, c.Duration, c.ScheduleDate
FROM Instructor i
